...
require_once('configs/config_vars.php'); // Переменные
require_once('configs/config_db.php'); // Конфигурации подключения к БД
require_once('manage/models/QueriesToDB.php'); // Запросы к БД

$userAuth = getUser($conn, $_SESSION['id']);
        ...
        <div class="wrapper">
            <ul class="header_menu">
                ...
                <li class="header_menu">
                    <?php
                    if ($userAuth == 'false' or $_GET['action'] == 'exit') {
                    ?>
                ...
                <li>
                    <a href="index.php?action=cart" class="button btn_primary primary">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
